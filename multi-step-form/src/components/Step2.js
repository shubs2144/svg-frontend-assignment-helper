    ...
    <div>
      ...
      <div className="flex flex-wrap md:flex-nowrap gap-4 mt-6">
        {plans.map((plan) => (
          <div
            key={plan.name}
            className={`w-full md:w-1/3 p-4 border rounded-lg cursor-pointer ${
          ...
          >
            ...
            <h2
              className={`text-lg font-bold ${
                selectedPlan === plan.name ? "text-marineBlue" : "text-coolGray"
              }`}
            >
              {plan.name}
            </h2>
      ...
      <div className="flex items-center justify-center mt-6 bg-magnolia py-3 rounded-lg">
        <p
          className={`mr-4 ${!isYearly ? "text-marineBlue font-bold" : "text-coolGray"}`}
        >
          Monthly
        </p>
        <button
          className="relative w-12 h-6 bg-marineBlue rounded-full"
        ...
        <p
          className={`ml-4 ${isYearly ? "text-marineBlue font-bold" : "text-coolGray"}`}
        >
          Yearly
        </p>
      </div>
